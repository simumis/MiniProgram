<template>
	...
	<view class="content">
		...
		<!-- 按钮 -->
		<view class="calc">
			<button type="primary" @click="onCalc" :disabled="(input_text[0].value=='' && input_text[4].value=='') || input_text[1].value=='' || input_text[2].value=='' || input_text[3].value=='' || input_text[5].value=='' || input_text[6].value=='' || input_text[7].value=='' || input_text[8].value=='' || input_text[9].value=='' || input_text[10].value=='' || input_text[11].value=='' || input_text[12].value==''">
				开始计算
			</button>
